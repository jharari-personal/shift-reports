...
##repsAPAC = "X:\\Sales\\Shortcuts\\!Shift_Reports_Folder\\repsAPAC.txt
##repsAU = "X:\\Sales\\Shortcuts\\!Shift_Reports_Folder\\repsAU.txt
##repsChina = "X:\\Sales\\Shortcuts\\!Shift_Reports_Folder\\repsChina.txt
##repsEU = "X:\\Sales\\Shortcuts\\!Shift_Reports_Folder\\repsEU.txt
##repsFSR = "X:\\Sales\\Shortcuts\\!Shift_Reports_Folder\\repsFSR.txt"
##ShiftReportsAPAC = "X:\\Sales\\Shortcuts\\!Shift_Reports_Folder\\ShiftReportsAPAC.txt
##ShiftReportsAU = "X:\\Sales\\Shortcuts\\!Shift_Reports_Folder\\ShiftReportsAU.txt
##ShiftReportsChina = "X:\\Sales\\Shortcuts\\!Shift_Reports_Folder\\ShiftReportsChina.txt
##ShiftReportsEU = "X:\\Sales\\Shortcuts\\!Shift_Reports_Folder\\ShiftReportsEU.txt
##ShiftReportsFSR = "X:\\Sales\\Shortcuts\\!Shift_Reports_Folder\\ShiftReportsFSR.txt
...
def Write():  
	...
	typedSR = srEntry.get()
	typedCountry = countryEntry.get()
	typedAccount = accountEntry.get()
	if not typedSR:
		laying_content(team)
		label_noSR.grid(row=5, column=3)
		return
	if not typedCountry and not typedAccount:
		laying_content(team)
		label_noCountry.grid(row=5, column=3)
		return
		
	try:
				with open(srLocation, 'a', encoding="utf8",  errors='ignore') as file:
